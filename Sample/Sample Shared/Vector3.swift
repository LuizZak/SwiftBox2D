...
extension Vector3 {
    ...
    @inlinable
    public func distance(to vec: Vector3) -> Float {
        let d = self - vec
    ...
    @inlinable
    public func distanceSquared(to vec: Vector3) -> Float {
        let d = self - vec
...
extension Vector3 {
    ...
    // Float interaction
    @inlinable
    static public func + (lhs: Vector3, rhs: Float) -> Vector3 {
    ...
    @inlinable
    static public func / (lhs: Float, rhs: Vector3) -> Vector3 {
...
extension Vector3 {
    ...
    @inlinable
    public func ratio(_ ratio: Float, to other: Vector3) -> Vector3 {
...
extension Collection where Iterator.Element == Vector3 {
    ...
    func averageVector() -> Vector3 {
        if isEmpty {
            return .zero
        }

        return reduce(into: .zero) { $0 += $1 } / Float(count)
    }
}
